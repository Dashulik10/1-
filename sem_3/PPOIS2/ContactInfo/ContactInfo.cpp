...
bool ContactInfo::phoneInputCheck()
{
    return (telephone_number[0] == '+' && telephone_number.length() >= 13);
}

bool ContactInfo::isContactInfCompl()
{
    return (!telephone_number.empty() && !email.empty());
}
